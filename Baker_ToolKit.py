...
import nuke, operator, time, nuke.rotopaint as rp, math

#############################################
# Function to create Trackers from Rotoshapes
#
# this function is totally from Magno Borgo's RotoShapes to Tracker script. I only put it here to
#
#
def walker(obj, list):
    for i in obj:
...
#
#
# End of RotoShape_to_Trackers_function
########################################
...
cqnTools.addSeparator()
cqnTools.addCommand('Rotoshapes to Tracker', 'Baker_ToolKit.RotoShape_to_Trackers()', 'F4', icon='Bezier.png')
cqnTools.addSeparator()
